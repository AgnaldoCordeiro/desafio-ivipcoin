    ...
    <>
      ...
      >
        <Box width={theme.spacing(28)} height="100%" display="flex" flexDirection="column">
          <Box width={'auto'} height={theme.spacing(20)} display='flex' alignItems="center" justifyContent="center">
          <Avatar src={logoMenu} variant="square" sx={{ width: 'auto', height: '5rem' }} />
          </Box>
